...
export default function Formstyle() {
    return (
        <>
            <div>
                <form className="space-y-4 bg-yellow-50 p-6 shadow-2xl border-2 border-black">
                                ...
                                <div className="sm:col-span-4">
                                    ...
                                    <div className="mt-2">
                                        <div className="flex items-center rounded-md bg-white pl-3 outline-1 -outline-offset-1 outline-gray-300 focus-within:outline-2 focus-within:-outline-offset-2 focus-within:outline-indigo-600">
                                            <div className="shrink-0 text-base text-gray-500 select-none sm:text-sm/6">Topstech.com/</div>
                                            <input
                                                id="username"
                                                name="username"
                                                type="text"
                                                placeholder="alishapathan"
